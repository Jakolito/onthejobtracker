...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if (mysqli_num_rows($adviser_result) > 0) {
            ...
            $error_message = 'No academic adviser account found with this email address.';
        }
    }
}
?>
...
<head>
    ...
    <title>Academic Adviser Login - BULSU OnTheJob Tracker</title>
...
<body class="bg-gray-100 text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-8">
        <div class="bg-white bg-opacity-95 rounded-2xl shadow-2xl p-8 md:p-12 max-w-md w-full animate-fadeInUp">
            ...
            <form action="adviser-login.php" method="post" class="space-y-6">
                <div>
                    <label for="email" class="block text-gray-700 font-medium mb-2">Academic Email Address</label>
                    <input type="email" id="email" name="email" placeholder="Enter your academic email"
                        value="<?php echo $email_value; ?>" required
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-bulsu-gold transition-all duration-300 hover:border-bulsu-gold hover:border-opacity-50">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" placeholder="Enter your password" required
                            class="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-bulsu-gold transition-all duration-300 hover:border-bulsu-gold hover:border-opacity-50">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center text-sm gap-2">
                    ...
                    <a href="adminforgot.php" class="text-bulsu-gold hover:text-bulsu-dark-maroon transition font-medium">Forgot Password?</a>
                </div>
                
                <button type="submit"
                    class="w-full bg-gradient-to-r from-bulsu-maroon to-bulsu-dark-maroon text-white rounded-lg py-3 font-semibold shadow-lg hover:from-bulsu-dark-maroon hover:to-black transition-all duration-300 transform hover:scale-105">
                    Log In as Academic Adviser
                </button>
            </form>
